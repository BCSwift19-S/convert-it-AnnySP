...
//  Convert It
//
//  Created by Anny Shan on 2/25/19.
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var formularPicker: UIPickerView!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        formularPicker.delegate = self
        formularPicker.dataSource = self
        conversionString = formulasArray[formularPicker.selectedRow(inComponent: 0)].conversionString
    ...
    func calculateConversion() {
        ...
        let outputValue = formulasArray[formularPicker.selectedRow(inComponent: 0)].formula(inputValue)
    ...
    @IBAction func convertButtomPressed(_ sender: UIButton) {
        calculateConversion()
    }
